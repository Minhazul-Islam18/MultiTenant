...
Route::middleware('guest')->group(function () {
    ...
    Route::get('merchant-login', [AuthenticatedSessionController::class, 'merchantLogin'])
        ->name('merchant-login');

    Route::post('merchant-login', [AuthenticatedSessionController::class, 'merchantLoginPost'])
        ->name('merchant-login.post');
